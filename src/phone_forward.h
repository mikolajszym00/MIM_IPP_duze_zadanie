 ...
 * Wyznacza następujący ciąg numerów: jeśli istnieje prefiks @p x pewnego numeru,
 * dla którego istnieje przekierowanie będące prefiksem @p num, to @p x oraz część
 * @p num pozbawiona prefiksu tworzą nowy numer, który należy do wyniku wywołania
 * @ref phfwdReverse z numerem @p num. Dodatkowo ciąg wynikowy zawsze zawiera
 * też numer @p num. Wynikowe numery są posortowane leksykograficznie i nie mogą
 * się powtarzać. Jeśli podany napis nie reprezentuje numeru, wynikiem jest pusty
